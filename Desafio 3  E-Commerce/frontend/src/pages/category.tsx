...
//   if (type === 'pets') lastPage = petsFilters.limit;

//   if (type === 'products')  lastPage = productsFilters.limit;
      ...
      <div id="category-content">
        ...
        <section>
          ...
          <div className="pagination">
            ...
            <Button disabled={pets.length < petsFilters.limit} text="Próxima &gt;" backgroundColor="var(--neutral)" color="var(--terciary)" haveLink={true} border="none" onClick={() => setCurrentPage(p => p + 1)}/> 
          </div>
        </section>
      </div>
      <Footer />
