    ...
    return (
        <div id="homePage">
            ...
            <main>
                <section id="welcome-area">
                    <div>
                        ...
                        <div>
                            ...
                            <Button text="Explore Now" backgroundColor="var(--terciary)" color="var(--neutral)" border="0.1px solid var(--terciary)" haveLink={true} nextPage="/category" />
                        </div>
                    </div>
                ...
                <div id="banner-1">
                    <Banner backgroundImage={backgroundImage2} title="One More Friend" subtitle="Thousands More Fun!" text="Having a pet means you have more joy, a new friend, a happy person who will always be with you to have fun. We have 200+ different pets that can meet your needs!" nextPage="/category" backgroundColor="var(--terciary)" side="end" />
                </div>
                ...
                <section id="information-section">
                    ...
                    <Banner backgroundImage={backgroundImage3} title="Adoption" subtitle="We Need Help. So Do They" text="Adopt a pet and give it a home, it will be love you back unconditionally." nextPage="/category" backgroundColor="var(--quaternary)" side="start" />
